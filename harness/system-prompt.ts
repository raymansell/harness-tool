// Notice how the agent is being told to send the reply.
// Currently it will dutifully email three customers with
// no human in the loop. This will be fixed later.
